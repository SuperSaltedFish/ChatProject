...
public class ConversationTestData {
    ...
    public static List<ConversationBean> getTestData() {
        ...
        single1.setLastMessage("Banjo tote bag bicycle rights ,Hi.");
        single2.setLastMessage("Fixie tite bag ethnic keytar");
        single3.setLastMessage("Tousied food truck polaroid ,saivodiw shawos");
        single4.setLastMessage("Hella narwhal");
        single5.setLastMessage("food truck");
        single6.setLastMessage("Bushwick meh Blue Bottle bell");
        group1.setLastMessage("Retro occupy organic,Stumptown shcdwa");
        group2.setLastMessage("Retro occupy organic,Stumptown shcdwa");
