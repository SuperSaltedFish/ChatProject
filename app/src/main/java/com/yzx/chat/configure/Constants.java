...
public static final String URL_API_BASE = "http://www.orline.cn/superim/v1/api/";

    public static final String URL_MAP_IMAGE_FORMAT = "http://restapi.amap.com/v3/staticmap?markers=-1,www.orline.cn/superim/ic_location_flag.png,0:%f,%f&size=400*160&zoom=15&key=ded050da042a8b77a62c6cda02cc330a";
